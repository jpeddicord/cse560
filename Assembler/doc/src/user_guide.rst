...
This assembler does not have any known limitations beyond limits required by the software being used to run it.

The .NET 4 framework has the following requirements†:
...
Mono has the following requirements†:
